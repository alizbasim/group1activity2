...
def aed_to_usddollar(money):
    rate = 0.27
    return money * rate  #return statement to return to send a result back to the caller function
...
print("Main menu! this is the conversion game where you will convert AED to:") #print statement which displays output to the terminal 
...
while True: #while loop will constantly execute a block of code as long as a specified condition is true
       ...
       if main_choice == '1':
           ...
           elif sub_choice == '3': #elif is short for "else if"
